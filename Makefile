...
ifeq ($(ARCH), x86_64)
	make docker:tag-arch DOCKER_ARCH_URI=$(DOCKER_REGISTRY)/$(DOCKER_NAMESPACE)/$(IMAGE_NAME_ARCH):$(SEMVERSION)-rhel DOCKER_REGISTRY=$(DOCKER_INTEGRATION_REGISTRY)
	make docker:push-arch DOCKER_ARCH_URI=$(DOCKER_REGISTRY)/$(DOCKER_NAMESPACE)/$(IMAGE_NAME_ARCH):$(SEMVERSION)-rhel DOCKER_REGISTRY=$(DOCKER_INTEGRATION_REGISTRY)
endif
